...
new_opt = np.array([[ 0.8481861,  -0.06148506,  0.5261178,-3.30346709],
                    [ 0.04833077,  0.99808044,  0.03872431,  0.86282399],
                    [-0.52748885, -0.00741774,  0.84952957, -7.22911423],
                    [ 0.,          0.,          0.,          1.,        ]])
...
# ---start processing---
folder_path = "/home/nuc/Desktop/kinect_camera/DATA/disk" #-------------------------change this to raw data's folder name    #  Black_screen low_light calibration_cube
for filename in os.listdir(folder_path):
    ...
    if os.path.isfile(file_path):
        ...
        #-----------------------------------------------Downsampling----------------------------------------
        # voxel_size = 1   # 0.05 means 5cm for this dataset, lower voxel size corresponds to higher resolution   # 1 is original size
        ...
        #-----------------------------------------------general ICP
        # current_transformation = np.identity(4)
        # IPC_init = opt_1 # current_transformation   # result_ransac.transformation
        # icp_threshold = 10000  # 1 makes difference max_correspondence_distance
        # reg_p2p = o3d.pipelines.registration.registration_icp(
        #     pcd_right_crop_for_ICP, pcd_left_crop_for_ICP, icp_threshold, IPC_init,
        #     o3d.pipelines.registration.TransformationEstimationPointToPoint(),
        #     o3d.pipelines.registration.ICPConvergenceCriteria(max_iteration=50000))
        # print("trans before icp", opt_1)
        # print("trans after icp", reg_p2p.transformation)
        # draw_registration_result_original_color(pcd_right_crop_for_ICP, pcd_left_crop_for_ICP, new_opt)
        # draw_registration_result_original_color(pcd_right_crop_for_ICP, pcd_left_crop_for_ICP, opt_1)

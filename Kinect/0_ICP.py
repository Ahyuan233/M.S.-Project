...
class KINECT():
    ...
    def sync_capture_config(self):
        ...
        self.set_camera_configuration(device_index=1,
                                        ...
                                        synchronized_images_only=False,
                                        depth_delay_off_color_usec=0,
                                        sync_mode='Subordinate', # 'Standalone'
                                        subordinate_delay_off_master_usec=0) # 0
    ...
    def sync_capture(self):
        ...
        for i in range(int(reps)):
            ...
            # use distance filter
            distance_threshold = 700 # was 700
            ...
            reg_p2p = o3d.pipelines.registration.registration_icp(
                ...
                o3d.pipelines.registration.ICPConvergenceCriteria(max_iteration=5000)) # 5000
            ...
            # self.draw_registration_result(pcd_left, pcd_right, reg_p2p.transformation)
            # open3dVisualizer_left(pcd_left.points, img_left)
            pcd_combined = o3d.geometry.PointCloud()
            pcd_combined.points = o3d.utility.Vector3dVector([*pcd_left.points, *pcd_right.points]) # pcd_combined.points = o3d.utility.Vector3dVector([*pcd_left_crop.points, *pcd_right_crop.points])
